...
- [memovai/mimiclaw](https://github.com/memovai/mimiclaw) - Transforme une petite carte ESP32-S3 en assistant IA personnel. ![GitHub stars](https://img.shields.io/github/stars/memovai/mimiclaw?style=social)
- [nearai/ironclaw](https://github.com/nearai/ironclaw) - Implementation Rust inspiree d OpenClaw axee sur la confidentialite et la securite. ![GitHub stars](https://img.shields.io/github/stars/nearai/ironclaw?style=social)
...
- [sipeed/picoclaw](https://github.com/sipeed/picoclaw) - Implementation Go qui tourne sur du materiel a $10 avec <10MB de RAM. ![GitHub stars](https://img.shields.io/github/stars/sipeed/picoclaw?style=social)
...
- [pors/skill-audit](https://github.com/pors/skill-audit) - Toolkit d audit de skills pour valider et renforcer la qualite. ![GitHub stars](https://img.shields.io/github/stars/pors/skill-audit?style=social)
...
- [hyperspell/hyperspell-openclaw](https://github.com/hyperspell/hyperspell-openclaw) - Integration du plugin HyperSpell pour les workflows OpenClaw. ![GitHub stars](https://img.shields.io/github/stars/hyperspell/hyperspell-openclaw?style=social)
...
- [prompt-security/clawsec](https://github.com/prompt-security/clawsec) - Suite de securite avec detection de derive, audits et verification d integrite. ![GitHub stars](https://img.shields.io/github/stars/prompt-security/clawsec?style=social)
...
- [Unbrowse](https://www.unbrowse.ai/) - Plateforme pour transformer des workflows navigateur en integrations API et skills d agents.
